...
import com.bigone.oneone.adapter.Adapter;
import com.bigone.oneone.api.ApiUtilities;
import com.bigone.oneone.kotlin.AssistantMainActivity;
        ...
        public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
            switch (item.getItemId()){
                ...
                case R.id.navigation_covid:
                    Intent covidintent = new Intent(CovidActivity.this, CovidActivity.class);
                    startActivity(covidintent);
                    break;

                case R.id.navigation_oculus:
                    Intent oculusintent = new Intent(CovidActivity.this, AssistantMainActivity.class);
                    startActivity(oculusintent);
                    break;
