...
import com.bigone.oneone.data.AssistantDatabase
import com.bigone.oneone.databinding.ActivityAssistantBinding
...
class AssistantActivity : AppCompatActivity() {
        ...
        textToSpeech = TextToSpeech(this) {status ->
            if (status == TextToSpeech.SUCCESS){
                ...
                if(result == TextToSpeech.LANG_MISSING_DATA ||
                    ...
                    Log.e(logtts, "Language not supposted")
            ...
            override fun onResults(bundle: Bundle) {
                ...
                if(data != null){
                    ...
                    when{
                        ...
                        keeper.contains("hello") || keeper.contains("hi") || keeper.contains("hey")
    ...
    private fun makeAPhoneCall(){
        ...
        if(number.trim{it <= ' '}.length > 0){
            if(ContextCompat.checkSelfPermission(this,android.Manifest.permission.CALL_PHONE)!=PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.CALL_PHONE),REQUESTCALL)
            } else {
                val dial = "tel:$number"
    ...
    private fun readSMS(){
        if(ContextCompat.checkSelfPermission(this,android.Manifest.permission.READ_SMS)!= PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.READ_SMS),READSMS)
        } else{
    ...
    private fun openGmail(){
        val intent = packageManager.getLaunchIntentForPackage("com.google.android.gms")
        intent?.let {startActivity(it)}
    }

    private fun shareAFile(){
        if (ContextCompat.checkSelfPermission(this,android.Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.READ_EXTERNAL_STORAGE,android.Manifest.permission.WRITE_EXTERNAL_STORAGE),SHAREAFILE)
        } else {
    ...
    private fun callContact() {
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.READ_CONTACTS, android.Manifest.permission.WRITE_CONTACTS), READCONTACTS)
    ...
    private fun getAllPairedDevices(){
        if(bluetoothAdapter.isEnabled()){
            ...
            var text = ""
            var count = 1
            var devices: Set<BluetoothDevice> = bluetoothAdapter.getBondedDevices()
    ...
    fun clipBoardCopy(){
        ...
        if(!data.isEmpty()){
            ...
            speak("Data copied to clip that is $data")
        }
    }
    ...
    private fun capturePhoto(){
        if(ContextCompat.checkSelfPermission(this,android.Manifest.permission.CAMERA)!=PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.CAMERA,android.Manifest.permission.WRITE_EXTERNAL_STORAGE),CAPTUREPHOTO)
    ...
    private fun getDips(dps: Int): Int{
        ...
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,dps.toFloat(),resources.getDisplayMetrics()).toInt()
    }
